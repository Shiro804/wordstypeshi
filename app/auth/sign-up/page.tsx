...
export default function Page() {
  return (
    <div
      className="min-h-dvh w-full flex flex-col items-center justify-start p-6 md:p-10 relative"
    ...
    >
      ...
      <div className="flex flex-col items-center pt-8 pb-6">
        {/* Title */}
        <h1
          className="font-black text-[clamp(24px,5vw,40px)] text-white/90 text-center select-none mb-4"
          style={{
        ...
        {/* Animated Duck SVG - smaller for signup */}
        <svg
          className="w-[clamp(60px,12vw,100px)] h-auto animate-duck-bob"
          viewBox="0 0 320 320"
          role="img"
          aria-label="Duck mascot"
          style={{ filter: 'drop-shadow(0 4px 0 rgba(0,0,0,0.15))' }}
        >
          <g>
            {/* Sparkle */}
